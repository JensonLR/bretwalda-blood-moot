...
import { buildCharacter, buildWeaponForClass, buildShield, shieldBoard, peopleOf, defaultAppearance, ELBOW_ALONG, KNEE_ALONG, GRIP_ALONG, GRIP_PITCH, } from "../characters.js";
...
function drapeCloak(rig, motion, dt, t, billow) {
    ...
    for (let c = 0; c < cols; c++) {
        ...
        const tz = clamp((Math.atan2(lx + rx, down) + sway) * upright
            - DRAPE_SIDE[c] * (GATHER * still * upright - WING_SPLAY * (1 - still)), -SWING_SIDE, SWING_SIDE);
