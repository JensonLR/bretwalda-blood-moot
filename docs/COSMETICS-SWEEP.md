...
**47 options across 8 slots. 19 s wall clock, 0 rendered captures.** 14 of 14 assertions held.
...
| beard | Full Beard -> Forked Beard | 80g | 1.11% | 12.19% | 0.27% | 2.37% | — | — | DIFFERS |
| beard | Forked Beard -> Ringed Braid | 120g | 0.29% | 5.25% | 0.10% | 1.05% | — | — | DIFFERS |
...
| beard | Clean Shaven -> Close Crop | portrait | -90° | 0.75% | 5.50% | 54346 |
...
| beard | Close Crop -> Full Beard | portrait | -90° | 2.70% | 10.53% | 55854 |
| beard | Close Crop -> Full Beard | fight | -35° | 0.45% | 3.39% | 11697 |
| beard | Close Crop -> Full Beard | fight | -90° | 0.78% | 2.49% | 9059 |
| beard | Full Beard -> Forked Beard | portrait | -35° | 1.11% | 12.19% | 56859 |
| beard | Full Beard -> Forked Beard | portrait | -90° | 0.99% | 7.13% | 55854 |
| beard | Full Beard -> Forked Beard | fight | -35° | 0.27% | 2.37% | 11697 |
| beard | Full Beard -> Forked Beard | fight | -90° | 0.31% | 1.62% | 9059 |
| beard | Forked Beard -> Ringed Braid | portrait | -35° | 0.29% | 5.25% | 56230 |
| beard | Forked Beard -> Ringed Braid | portrait | -90° | 0.36% | 2.97% | 55300 |
| beard | Forked Beard -> Ringed Braid | fight | -35° | 0.10% | 1.05% | 11666 |
| beard | Forked Beard -> Ringed Braid | fight | -90° | 0.17% | 0.62% | 9031 |
...
| Shadow Hood | 30% | 0.85% | 7.31% | 4.36% |
| Ridge Helm | 29% | 0.07% | 7.10% | 4.83% |
| Spectacle Helm | 45% | 0.07% | 7.79% | 4.91% |
| Boar-Crest Helm | 45% | 0.07% | 7.06% | 4.80% |
| Jarl's Crowned Helm | 46% | 0.06% | 7.02% | 4.76% |
| Wyrm-Crest Helm | 46% | 0.00% | 5.40% | 3.78% |
...
|---|---|---|
| helm | Bare Head -> Iron Spangenhelm | 39.59% |
| helm | Iron Spangenhelm -> Nasal Helm | 24.02% |
| helm | Nasal Helm -> Shadow Hood | 50.49% |
| helm | Shadow Hood -> Ridge Helm | 52.31% |
| helm | Ridge Helm -> Spectacle Helm | 21.07% |
| helm | Spectacle Helm -> Boar-Crest Helm | 2.21% |
| helm | Boar-Crest Helm -> Jarl's Crowned Helm | 12.51% |
| helm | Jarl's Crowned Helm -> Wyrm-Crest Helm | 39.13% |
| helm | Wyrm-Crest Helm -> The Sutton Hoo Helm | 71.62% |
...
| beard | Full Beard -> Forked Beard | 21.21% |
| beard | Forked Beard -> Ringed Braid | 11.27% |
...
- Shadow Hood — Warrior Crop reads 0.85% under the Shadow Hood
- Shadow Hood — Long Mane reads 7.31% under the Shadow Hood
- Shadow Hood — Braided War-locks reads 4.36% under the Shadow Hood
