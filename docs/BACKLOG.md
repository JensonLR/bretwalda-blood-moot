...
| 7.5 | **Banners in the grounds (4.10)** | The §6 devices on planted 3D standards per ground + lobby rows. |
| 7.6 | **War seasons + leaderboards** | Ruled together (daily deeds explicitly NOT picked): named seasons a few weeks long, season's end crowns the leading people and resets the front; weekly rolls — top warriors by wins/kills/honour, per people and overall. |
