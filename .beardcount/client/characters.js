...
function beardShell(K, y0, nu, cut) {
    ...
    const topY = (u) => {
        ...
        const t2 = smooth(0.46, uE * 0.86, a);
    ...
    const jawY = (u) => {
        const a = Math.abs(u);
        return mix(-0.900, Y_GONION - 0.055, Math.pow(smooth(0.08, uE, a), 1.30))
        ...
        if (ap.beardStyle !== "none") {
            ...
            const cuts = {
                ...
                short: {
                    ...
                    mass: (u) => 0.20 + 0.80 * Math.pow(1 - smooth(0.66, 1.14, Math.abs(u)), 0.80),
                    lean: 0.20,
                    thick: 0.0034,
                ...
                full: {
                    ...
                    mass: (u) => 0.10 + 0.90 * Math.pow(1 - smooth(0.58, 1.14, Math.abs(u)), 0.85),
                    lean: 0.34,
                    thick: 0.006,
                    seatY, seatR, hank, rag,
                },
                ...
                forked: {
                    ...
                    mass: (u) => 0.09 + 0.91 * Math.pow(1 - smooth(0.50, 1.02, Math.abs(u)), 0.85),
                ...
                braided: {
                    ...
                    uEdge: 1.13,
                    prof: braidProfile(),
                    mass: (u) => 0.06 + 0.94 * Math.pow(1 - smooth(0.26, 0.96, Math.abs(u)), 1.20),
                    lean: 0.30,
                    thick: 0.005,
                    seatY, seatR, hank, rag,
                },
