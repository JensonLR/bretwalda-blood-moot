...
const TARGETS = [
  ...
  ["noseBeyondChin", 20, 9, "NOTE 1 — the beak. Life 18–22 mm on this head's scale"],
  ["noseBeyondLip", 26, 9, "tip in front of the lip line"],
  ["noseProjection", 26, 8, "tip off the nasion plane"],
  ["chinBeyondLip", -4, 8, "NOTE 2 — negative is a receding chin. A fighter sits at 0 to +6"],
  ...
  ["neckOverHead", 0.72, 0.06, "neck breadth / max head breadth. Life 0.72"],
  ...
  ["neckOverHeadHeight", 0.63, 0.07, "NOTE 4 — menton to shoulder JOINT / head height; life 0.63"],
];
